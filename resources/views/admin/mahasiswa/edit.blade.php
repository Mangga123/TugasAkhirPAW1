        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <h3 class="text-lg font-bold mb-4">Edit Mahasiswa: {{ $mahasiswa->name }}</h3>
                    ...
                    <form action="{{ route('mahasiswa.update', $mahasiswa->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="angkatan" id="angkatan" value="{{ old('angkatan', $mahasiswa->angkatan) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-xs text-gray-500 mt-1">*Biarkan kosong jika tidak ingin mengganti password.</p>
                        </div>
